...
function VideoPlayer() {
    ...
    videoElem.setAttribute('src', 'https://storage.googleapis.com/dynamic-video-hdfc/hdfc_team/hdfc_alka.mp4');
...
VideoPlayer.prototype.init = function() {
    ...
    var video = self.video;
       $('.js-name').text("HELLO ALKA");
        ...
        $('#animate6').text (
          "Hey Alka, click here to avail your Pre-approved Auto Loan offer"
        );
